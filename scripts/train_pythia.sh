...
CUDA_VISIBLE_DEVICES=3,4 nohup torchrun --nproc_per_node 2 train.py \
    ...
    --output_dir $your_checkpoint_path/yitushibie-pythia-1b-lora-$LR \
    ...
    --lora_config configs/${lora_config}.json \
        > experiments/outputs/yitushibie-pythia-1b-lora-$LR/log 2>&1 &
