...
from transformers import LlamaForCausalLM, LlamaTokenizer, AutoModel, AutoTokenizer, GPTNeoXForCausalLM
...
if __name__=='__main__':
    ...
    for lora_index, lora_model_path in enumerate(lora_model_paths):
        ...
        first_weight = base_model.gpt_neox.layers[2].attention.query_key_value.weight     # pythia
        first_weight_old = first_weight.clone()
        # print(base_model.gpt_neox.layers[2].attention.query_key_value.weight)
        ...
        if hasattr(peft.LoraModel, 'merge_and_unload'):
            try:
                ...
                # print(list(lora_model.base_model.model.gpt_neox.layers[0].attention.query_key_value.lora_B.default.parameters()))
